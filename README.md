...
## USEFUL LINKS
**[CODE](https://version.helsinki.fi/hus_hematology/tcga-kirc-immunology)** &emsp; &emsp; &emsp; &emsp; &nbsp; &nbsp; The [codes](https://version.helsinki.fi/hus_hematology/tcga-kirc-immunology) to reproduce the texture and lymphocyte data.  
**DATA** &emsp; &emsp; &emsp; &emsp; &emsp; The annotated image data are located in [Zenodo](https://zenodo.org/deposit/6384627).  
**VISUALIZATION** &emsp; &nbsp;The [TissUUmaps platform](http://hruh-20.it.helsinki.fi/rcc_texture_lymphocytes/) to visualize the texture and lymphocyte data.
