...
## USEFUL LINKS
**CODE** &emsp;   &emsp;   &emsp;  The [codes](https://version.helsinki.fi/hus_hematology/tcga-kirc-immunology) to reproduce the texture and lymphocyte data.  
**DATA** &emsp;   &emsp;   &emsp;  The annotated image data are located in [Zenodo](https://zenodo.org/deposit/6384627).  
