...
# Plot
png("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Ly/Images/TCGA_ly_ly_corrplot.png", width = 6, height = 6, units = 'in', res = 300, pointsize = 12) #original pointsize = 12
corrplot(r %>% round(2),
         cl.ratio = 0.2,
         method="color",
