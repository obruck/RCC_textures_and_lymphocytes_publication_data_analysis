...
print("Start Textures/Scripts/Texture/Texture_heatmap_stroma_w_vs_wo_normal.R")
...
# Load data
stroma_w_normal_gexp_pathways0 <- readxl::read_xlsx("Textures/Images/Stroma_WithNormal/Gexp/gexp_gene_pathways.xlsx")
stroma_wo_normal_gexp_pathways0 <- readxl::read_xlsx("Textures/Images/Stroma/Gexp/gexp_gene_pathways.xlsx")
