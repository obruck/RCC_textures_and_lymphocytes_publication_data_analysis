  ...
  for (texture1 in c("All", as.list(unique(tcga_kirc0$Texture))) ) {
    ...
    # Export data
    writexl::write_xlsx(pvalue_df, paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/Ly_in_margin_vs_nonmargin_", texture1, "_gexp.xlsx"))
    ...
    png(paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/", texture1, "_gexp_top20_selectedpathways.png"), width = 11.5, height = 3.5, units = 'in', res = 300)
    ...
    ggsave(plot = g, filename = paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/", texture1, "_pathways_barplot.png"), width = max(5.5, 5+max(nchar(fgseaRes_res2$pathway))/23), height = max(2, (1+nrow(fgseaRes_res2)/5.5)), units = 'in', dpi = 300)
    ...
    ggsave(plot = g1, filename = paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/", texture1, "_gexp_volcano_p0005.png"), width = 7, height = 7, units = 'in', dpi = 300)
    ggsave(plot = g2, filename = paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/", texture1, "_gexp_volcano_p0001.png"), width = 7, height = 7, units = 'in', dpi = 300)
    ggsave(plot = g3, filename = paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/", texture1, "_gexp_volcano_p00005.png"), width = 7, height = 7, units = 'in', dpi = 300)
    ggsave(plot = g4, filename = paste0("/Users/oscarbruck/OneDrive - University of Helsinki/RCC/Otso/Analysis/Textures/Images/Margin/Margin_vs_non_margin/Ly/Gexp/", texture1, "_gexp_volcano_p00001.png"), width = 7, height = 7, units = 'in', dpi = 300)
